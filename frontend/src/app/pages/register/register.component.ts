        ...
        <mat-card-content>
          ...
          <form [formGroup]="form" (ngSubmit)="onSubmit()">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <input matInput formControlName="mobile" type="tel" maxlength="10" />
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <mat-error *ngIf="form.hasError('passwordsMismatch') && !form.get('confirmPassword')?.hasError('required')">Passwords do not match</mat-error>
            </mat-form-field>
            ...
            <div class="city-row">
              ...
              <mat-form-field appearance="outline">
                ...
                <mat-select formControlName="state">
                  <mat-option *ngFor="let s of indianStates" [value]="s">{{ s }}</mat-option>
                </mat-select>
                <mat-error *ngIf="form.get('state')?.hasError('required')">State is required</mat-error>
              </mat-form-field>
              <mat-form-field appearance="outline">
                <mat-label>PIN Code</mat-label>
                <input matInput formControlName="zip_code" type="text" maxlength="6" />
                <mat-error *ngIf="form.get('zip_code')?.hasError('required')">PIN code is required</mat-error>
                <mat-error *ngIf="form.get('zip_code')?.hasError('pattern')">Enter a valid 6-digit PIN code</mat-error>
              </mat-form-field>
            </div>
...
export class RegisterComponent implements OnInit, OnDestroy {
  ...
  constructor(private fb: FormBuilder, private store: Store) {
    this.form = this.fb.group({
      ...
      zip_code: ['', [Validators.required, Validators.pattern(/^[1-9][0-9]{5}$/)]],
